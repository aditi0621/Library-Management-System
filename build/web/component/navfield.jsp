<nav class="navbar navbar-expand-lg navbar-dark bg-secondary text-white" >
  <div class="container-fluid">
      ...
      <a class="navbar-brand" ><i class="fa-solid fa-book-open"></i>    OUR LIBRARY</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="myBooksRetrieve.jsp"><i class="fa-solid fa-swatchbook"></i> MY BOOKS</a>
        </li>
